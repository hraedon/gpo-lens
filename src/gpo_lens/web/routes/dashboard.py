        ...
        try:
            try:
                ...
                summary = EstateSummary(
                    ...
                    unlinked_count=0,
                    empty_count=0,
                    disabled_but_populated_count=0,
                    conflict_count=0,
                    blocked_extension_count=0,
                    version_skew_count=0,
                    ms16_072_vulnerable_count=0,
                    cpassword_hit_count=0,
                    loopback_gpo_count=0,
                    wmi_filtered_gpo_count=0,
                    enforced_link_count=0,
                    dangling_link_count=0,
                    broken_ref_count=0,
                    admx_gap_count=0,
                    broken_wmi_ref_count=0,
                    orphaned_wmi_filter_count=0,
                    ilt_gpo_count=0,
                    stale_gpo_count=0,
                    danger_finding_count=0,
                    total_settings=0,
                    total_delegation_entries=0,
                )
        finally:
            conn.close()
